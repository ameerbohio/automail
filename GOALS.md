...
- Study doc number: `docs/study/` already carries a duplicated `17-` prefix. K0 took
  **24** (`24-graceful-shutdown-consumer-lifecycle.md`) and K1 took **25**
  (`25-k3d-cluster-image-supply.md` — substrate and registry-less image supply), so the
  next free number is **26** (`docs/study/26-kubernetes-orchestration.md`).
