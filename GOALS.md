...
6. **Study doc**: Part 9 (Goal T11) adds `docs/study/30-testing-strategy.md`;
...
`docs/study/30-testing-strategy.md` (pyramid, fakes-vs-real, how invariants are
...
`services/portal/tests/ingress/ingress.spec.ts`.
